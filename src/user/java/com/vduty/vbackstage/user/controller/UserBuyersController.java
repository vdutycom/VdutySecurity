...
@Controller
@RequestMapping("/usercenter/requirements")
public class UserBuyersController {
	static final Logger logger  =  LogManager.getLogger(UserBuyersController.class);
	@Autowired
	...
	@RequestMapping("") 
	  ...
	  return"views/usercenter/requirements/index"; 
	  } 
	...
	public String getuser(@PathVariable Long id, Model model)
	{
		...
		return "views/usercenter/requirements/getuser";
	}
